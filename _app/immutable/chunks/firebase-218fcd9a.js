 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zy(){return new Pn("deleteField")}(function(t,e=!0){(function(n){Dt=n})(dn),mt(new We("firestore",(n,{options:s})=>{const r=n.getProvider("app").getImmediate(),i=new Fe(r,new zp(n.getProvider("auth-internal")),new Xp(n.getProvider("app-check-internal")));return s=Object.assign({useFetchStreams:e},s),i._setSettings(s),i},"PUBLIC")),Oe(Ko,"3.4.11",t),Oe(Ko,"3.4.11","esm2017")})();const qy={apiKey:"AIzaSyBzusLOWN7a_sSCbm2TvzO0G3rkNGDnYlE",authDomain:"abicos.firebaseapp.com",projectId:"abicos",storageBucket:"abicos.appspot.com",messagingSenderId:"1007319276577",appId:"1:1007319276577:web:3ae3d6e77fbbe2779a9760"};kh(qy);const xn=Uf(),Hy=Cy(),ev=async()=>{await Sd(xn,ei)},tv=async(t,e)=>{const n=await _d(xn,t,e);return await Ky(n),n},nv=async(t,e)=>await Td(xn,t,e),sv=async()=>await bd(xn),rv=()=>xn.currentUser;async function Ky(t){const e=by(Sy(Hy,"users"),t.user.uid),n={UID:t.user.uid,currentFolder:"",email:t.user.email,firstName:"",lastName:"",avatar:"/images/profile-images/user-default-logo.png",tags:[{text:"important",color:"#ff1234",colorText:"#000000"}]};await jy(e,n)}export{Cy as B,by as D,Jy as E,Yy as I,Gy as Q,zy as U,Sy as V,Zy as a,sv as b,nv as c,tv as d,Hy as f,rv as g,ev as i,Wy as l,Xy as p,F as u,Qy as w,jy as y};
